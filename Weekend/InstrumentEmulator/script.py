...
def buttonG():
  ...
  sound.play()
def buttonH():
  sound = pygame.mixer.Sound("sound/Bb.wav")
  sound.play()
def buttonI():
  sound = pygame.mixer.Sound("sound/C_s.wav")
  sound.play()
def buttonJ():
  sound = pygame.mixer.Sound("sound/C_s1.wav")
  sound.play()
def buttonK():
  sound = pygame.mixer.Sound("sound/C1.wav")
  sound.play()
def buttonL():
  sound = pygame.mixer.Sound("sound/D_s.wav")
  sound.play()
def buttonM():
  sound = pygame.mixer.Sound("sound/D_s1.wav")
  sound.play()
def buttonN():
  sound = pygame.mixer.Sound("sound/D1.wav")
  sound.play()
