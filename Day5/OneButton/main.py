...
def display_obstacle(height):
    ...
    pygame.draw.rect(SCREEN, OBSTACLE_COLOR, (obstacle_x, 635,
...
def start():
    ...
    display = startFont.render(
        f"PRESS SPACE BAR TO START", True, (255, 255, 255))
...
def game_over():
    ...
    if score == maximum:
        display3 = game_over_font2.render(
            f"NEW HIGH SCORE!!", True, (200, 35, 35))
...
while running:
    ...
    collision = collision_detection(
        obstacle_x, OBSTACLE_HEIGHT, bird_y, OBSTACLE_HEIGHT + 150)
